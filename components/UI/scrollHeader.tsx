export default function ScrollHeader() {
    return<div>
        ...
        <div className="scroll-parent-mobile py-3 my-4 sm:hidden">
            <p className="scroll-element primary text-clip font-black text-neutral-100 text-l">&nbsp;Sourcing, Recruiting, and Tool setup for <span className="text-lime-300">Web3</span> orgs</p>
            <p className="scroll-element secondary text-clip font-black text-neutral-100 text-l">&nbsp;Sourcing, Recruiting, and Tool setup for <span className="text-lime-300">Web3</span> orgs</p>
        </div>
    </div>
}