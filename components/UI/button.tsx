export default function Button() {
    ...
    <button onClick={(e) => {window.location.href ='mailto:hello@scalesecurity.xyz';}} className="text-lime-400 md:hidden md:font-black text-2xl hover:bg-lime-400 hover:text-white border-2 border-lime-400 rounded-lg py-3 my-4">
        HELLO@SCALESECURITY.XYZ
    </button>
    </div>
}